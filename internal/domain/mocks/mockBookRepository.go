...
func (_m *BookRepository) DeleteBook(ctx context.Context, id int) (int, error) {
...
func (_m *BookRepository) GetBooks(ctx context.Context) ([]domain.Book, error) {
	ret := _m.Called(ctx)
...
func (_m *BookRepository) NewBook(ctx context.Context, req domain.Book) (int, error) {
...
func (_m *BookRepository) UpdateBook(ctx context.Context, req domain.Book) (int, error) {
	ret := _m.Called(ctx, req)
